class ValidPalindrome1 {
    ...
    public static String isPalindrome(String s) {
        ...
        int i = 1;
        // The terminating condition for the loop is when both the pointers reach the
        // same element or when they cross each other.
        while (left < right) {
            ...
            System.out
                    .println("The current element being pointed to by the right pointer is '" + s.charAt(right) + "'");
